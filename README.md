...
Start by setting up an [incoming webhook integration](https://my.slack.com/services/new/incoming-webhook/) in your Slack workspace, then use the module as follows:
...
* [Basic Example](https://github.com/alibabacloud-automation/terraform-alicloud-notify-slack/tree/main/examples/basic)
* [Advanced Example](https://github.com/alibabacloud-automation/terraform-alicloud-notify-slack/tree/main/examples/advanced)
